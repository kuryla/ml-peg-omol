"""
Analyse the L14 complexes binding energy benchmark.
...
CALC_PATH = CALCS_ROOT / "supramolecular" / "L14" / "outputs"
OUT_PATH = APP_ROOT / "data" / "supramolecular" / "L14"
...
@pytest.fixture
@plot_parity(
    filename=OUT_PATH / "figure_L14.json",
    title="Energies",
...
@pytest.fixture
@build_table(
    filename=OUT_PATH / "L14_metrics_table.json",
...
def test_l14(metrics: dict[str, dict]) -> None:
    """
    Run L14 test.
