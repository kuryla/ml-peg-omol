...
CALC_PATH = CALCS_ROOT / "single_point" / "mpconf196" / "outputs"
OUT_PATH = APP_ROOT / "data" / "single_point" / "mpconf196"
print(APP_ROOT)
...
@pytest.fixture
@plot_parity(
    filename=OUT_PATH / "figure_mpconf196.json",
    title="Energies",
...
def test_mpconf196(metrics: dict[str, dict]) -> None:
    """
    Run MPCONF196 test.
