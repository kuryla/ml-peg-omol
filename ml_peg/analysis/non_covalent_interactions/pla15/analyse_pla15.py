"""Analyse PLA15 benchmark 10.1021/acs.jcim.9b01171."""
...
CALC_PATH = CALCS_ROOT / "non_covalent_interactions" / "pla15" / "outputs"
OUT_PATH = APP_ROOT / "data" / "non_covalent_interactions" / "pla15"
...
@pytest.fixture
@plot_parity(
    filename=OUT_PATH / "figure_pla15.json",
