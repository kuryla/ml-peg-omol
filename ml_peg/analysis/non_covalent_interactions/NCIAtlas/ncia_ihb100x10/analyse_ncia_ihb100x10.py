"""Analyse ncia_ihb100x10 benchmark."""
...
CALC_PATH = CALCS_ROOT / "non_covalent_interactions" / "NCIAtlas" / "ncia_ihb100x10" / "outputs"
OUT_PATH = APP_ROOT / "data" / "non_covalent_interactions" / "NCIAtlas" / "ncia_ihb100x10"
...
@pytest.fixture
@plot_parity(
    filename=OUT_PATH / "figure_ncia_ihb100x10.json",
...
def test_ncia_ihb100x10(metrics: dict[str, dict]) -> None:
    """
    Run ncia_ihb100x10 test.
