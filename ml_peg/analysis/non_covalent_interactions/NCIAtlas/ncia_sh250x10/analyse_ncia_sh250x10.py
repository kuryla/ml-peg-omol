"""Analyse ncia_sh250x10 benchmark."""
...
CALC_PATH = CALCS_ROOT / "non_covalent_interactions" / "NCIAtlas" / "ncia_sh250x10" / "outputs"
OUT_PATH = APP_ROOT / "data" / "non_covalent_interactions" / "NCIAtlas" / "ncia_sh250x10"
