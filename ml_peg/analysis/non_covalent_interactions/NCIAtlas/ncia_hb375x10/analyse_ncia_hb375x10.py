"""Analyse ncia_hb375x10 benchmark."""
...
CALC_PATH = CALCS_ROOT / "non_covalent_interactions" / "NCIAtlas" / "ncia_hb375x10" / "outputs"
OUT_PATH = APP_ROOT / "data" / "non_covalent_interactions" / "NCIAtlas" / "ncia_hb375x10"
...
@pytest.fixture
@plot_parity(
    filename=OUT_PATH / "figure_ncia_hb375x10.json",
...
def test_ncia_hb375x10(metrics: dict[str, dict]) -> None:
    """
    Run ncia_hb375x10 test.
