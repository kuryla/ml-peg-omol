...
CALC_PATH = CALCS_ROOT / "non_covalent_interactions" / "NCIAtlas" / "ncia_d442x10" / "outputs"
OUT_PATH = APP_ROOT / "data" / "non_covalent_interactions" / "NCIAtlas" / "ncia_d442x10"
...
@pytest.fixture
@plot_parity(
    filename=OUT_PATH / "figure_ncia_d442x10.json",
