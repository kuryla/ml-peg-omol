...
class NCIA_D442x10_Benchmark(zntrack.Node):
    """
    Benchmarking NCIA_D442x10 benchmark dataset
    """
    ...
    def get_ref_energies(self, data_path):
        self.ref_energies = {}
        with open(data_path / 'NCIA_D442x10_benchmark.txt') as lines:
    ...
    def run(self):
        ...
        data_path = get_benchmark_data("NCIA_D442x10.zip") / "NCIA_D442x10"
...
def build_project(repro: bool = False) -> None:
    ...
    for model_name, model in MODELS.items():
        with project.group(model_name):
            benchmark = NCIA_D442x10_Benchmark(
                model=model,
...
def test_ncia_d442x10():
    """Run NCIA_D442x10 barriers benchmark via pytest."""
