...
class NCIA_HB300SPXx10_Benchmark(zntrack.Node):
    """
    Benchmarking NCIA_HB300SPXx10 ionic hydrogen bonds benchmark dataset
    """
    ...
    def get_ref_energies(self, data_path):
        self.ref_energies = {}
        with open(data_path / 'NCIA_HB300SPXx10_benchmark.txt') as lines:
    ...
    def run(self):
        ...
        data_path = get_benchmark_data("NCIA_HB300SPXx10.zip") / "NCIA_HB300SPXx10"
...
def build_project(repro: bool = False) -> None:
    ...
    for model_name, model in MODELS.items():
        with project.group(model_name):
            benchmark = NCIA_HB300SPXx10_Benchmark(
                model=model,
...
def test_ncia_hb300spxx10():
    """Run NCIA_HB300SPXx10 barriers benchmark via pytest."""
