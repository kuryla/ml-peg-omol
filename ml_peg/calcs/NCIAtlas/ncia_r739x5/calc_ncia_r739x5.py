...
class NCIA_R739x5_Benchmark(zntrack.Node):
    """
    Benchmarking NCIA_R739x5 repulsive contacts benchmark dataset
    """
    ...
    def run(self):
        ...
        data_path = get_benchmark_data("NCIA_R739x5.zip") / "NCIA_R739x5"
...
def build_project(repro: bool = False) -> None:
    ...
    for model_name, model in MODELS.items():
        with project.group(model_name):
            benchmark = NCIA_R739x5_Benchmark(
                model=model,
...
def test_ncia_r739x5():
    """Run NCIA_R739x5 barriers benchmark via pytest."""
