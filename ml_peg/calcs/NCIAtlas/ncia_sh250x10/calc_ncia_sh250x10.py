...
class NCIA_SH250x10_Benchmark(zntrack.Node):
    """
    Benchmarking NCIA_SH250x10 benchmark dataset
    """
    ...
    def run(self):
        ...
        data_path = get_benchmark_data("NCIA_SH250x10.zip") / "NCIA_SH250x10"
...
def build_project(repro: bool = False) -> None:
    ...
    for model_name, model in MODELS.items():
        with project.group(model_name):
            benchmark = NCIA_SH250x10_Benchmark(
                model=model,
