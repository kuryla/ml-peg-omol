...
class PLF547_Benchmark(zntrack.Node):
    """
    ...
    def run(self):
        ...
        ref_energies = self.parse_plf547_references(DATA_PATH / 'PLA15_pdbs' / 'reference_energies.txt')
        
        calc = self.model.get_calculator()

        for label, ref_energy in ref_energies.items():
            pdb_fname = DATA_PATH / 'PLA15_pdbs' / f'{label}.pdb'
